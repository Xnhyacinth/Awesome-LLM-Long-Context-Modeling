...
- **[2024.03.27]**
    - Paper: [Naive Bayes-based Context Extension for Large Language Models](https://arxiv.org/abs/2403.17552)
    - Paper: [PCToolkit: A Unified Plug-and-Play Prompt Compression Toolkit of Large Language Models](https://arxiv.org/abs/2403.17411)
...
- **[2024.03.20]**
    ...
    - Paper: [NovelQA: A Benchmark for Long-Range Novel Question Answering](https://arxiv.org/abs/2403.12766)

- **[2024.03.19]**
    - Paper: [Counting-Stars: A Simple, Efficient, and Reasonable Strategy for Evaluating Long-Context Large Language Models](https://arxiv.org/abs/2403.11802)

- **[2024.03.15]**
    - Paper: [Dynamic Memory Compression: Retrofitting LLMs for Accelerated Inference](https://arxiv.org/abs/2403.09636)
    - Paper: [StreamingDialogue: Prolonged Dialogue Learning via Long Context Compression with Minimal Losses](https://arxiv.org/abs/2403.08312)

- **[2024.03.11]**
    - Paper: [Can't Remember Details in Long Documents? You Need Some R&R](https://arxiv.org/abs/2403.05004)
    - Paper: [Found in the Middle: How Language Models Use Long Contexts Better via Plug-and-Play Positional Encoding](https://arxiv.org/abs/2403.04797)
